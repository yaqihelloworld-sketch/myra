...
const translations = {
  ...
  "home.addBucketListDesc": { en: "Archive a place or experience you dream of visiting.", zh: "记录你梦想中的目的地或体验。" },
  "home.discoverTrip": { en: "Discover a Trip", zh: "发现旅程" },
  "home.discoverTripDesc": { en: "Set your context and discover matching experiences.", zh: "设定偏好，发现匹配的体验。" },
  "home.wishlist": { en: "WISHLIST", zh: "心愿" },
  "home.planned": { en: "PLANNED", zh: "已计划" },
  "home.visited": { en: "COMPLETED", zh: "已完成" },

  // Bucket list page
  "bucket.archive": { en: "THE ARCHIVE", zh: "档案馆" },
  ...
  "discover.placeholder": { en: "I want to feel completely lost in a new culture...", zh: "我想完全沉浸在一种全新的文化中..." },
  "discover.chip1": { en: "Feel lost in a new culture", zh: "沉浸在新文化中" },
